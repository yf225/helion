...
class TestTypePropagation(TestCase):
    def test_add(self):
        output = type_propagation_report(
            import_path(datadir / "basic_kernels.py").add,
        ...
        self.assertExpectedInline(
            ...
            """\
def add(x, y):
    # Call: SequenceType((TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32))) SourceOrigin(location=<SourceLocation basic_kernels.py:8>)
    ...
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction add>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction add>)
    x, y = torch.broadcast_tensors(x, y)
    # Call: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation basic_kernels.py:9>)
    ...
    # Name: PythonModuleType(torch) GlobalOrigin(name='torch', function=<HostFunction add>)
    # Name: TensorType([x_size0, x_size1], torch.int32) GetItemOrigin(value=SourceOrigin(location=<SourceLocation basic_kernels.py:8>), key=0)
    # For: loop_type=GRID
    out = torch.empty_like(x)
    # Call: IterType(SequenceType([TileIndexType, TileIndexType])) SourceOrigin(location=<SourceLocation basic_kernels.py:10>)
    ...
    # Call: SequenceType((SymIntType(s0), SymIntType(s1))) SourceOrigin(location=<SourceLocation basic_kernels.py:10>)
    # Attribute: TensorAttributeType AttributeOrigin(value=SourceOrigin(location=<SourceLocation basic_kernels.py:9>), key='size')
    # Name: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation basic_kernels.py:9>)
    for tile in hl.tile(out.size()):
        # Subscript: TensorType([block_size0, block_size1], torch.int32) DeviceOrigin(location=<SourceLocation basic_kernels.py:11>)
        # Name: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation basic_kernels.py:9>)
        # Name: SequenceType([TileIndexType, TileIndexType]) SourceOrigin(location=<SourceLocation basic_kernels.py:10>)
        # BinOp: TensorType([block_size0, block_size1], torch.int32) DeviceOrigin(location=<SourceLocation basic_kernels.py:11>)
        # Subscript: TensorType([block_size0, block_size1], torch.int32) DeviceOrigin(location=<SourceLocation basic_kernels.py:11>)
        # Name: TensorType([x_size0, x_size1], torch.int32) GetItemOrigin(value=SourceOrigin(location=<SourceLocation basic_kernels.py:8>), key=0)
        # Name: SequenceType([TileIndexType, TileIndexType]) SourceOrigin(location=<SourceLocation basic_kernels.py:10>)
        # Subscript: TensorType([block_size0, block_size1], torch.int32) DeviceOrigin(location=<SourceLocation basic_kernels.py:11>)
        # Name: TensorType([x_size0, x_size1], torch.int32) GetItemOrigin(value=SourceOrigin(location=<SourceLocation basic_kernels.py:8>), key=1)
        # Name: SequenceType([TileIndexType, TileIndexType]) SourceOrigin(location=<SourceLocation basic_kernels.py:10>)
...
def all_ast_nodes(x, y):
    ...
    joined_string = 'abc'
    # List: SequenceType([TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32), LiteralType(1024)]) SourceOrigin(location=<SourceLocation all_ast_nodes.py:26>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    # Name: LiteralType(1024) SourceOrigin(location=<SourceLocation all_ast_nodes.py:23>)
    list_literal0 = [x, y, int_literal]
    # Tuple: SequenceType((TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32), LiteralType(1), LiteralType(2))) SourceOrigin(location=<SourceLocation all_ast_nodes.py:27>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    ...
    # List: SequenceType([LiteralType(5), TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32), LiteralType(1024), LiteralType(3), TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32), LiteralType(1), LiteralType(2), LiteralType(4)]) SourceOrigin(location=<SourceLocation all_ast_nodes.py:28>)
    # Constant: LiteralType(5) SourceOrigin(location=<SourceLocation all_ast_nodes.py:28>)
    # Name: SequenceType([TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32), LiteralType(1024)]) SourceOrigin(location=<SourceLocation all_ast_nodes.py:26>)
    # Constant: LiteralType(3) SourceOrigin(location=<SourceLocation all_ast_nodes.py:28>)
    # Name: SequenceType((TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32), LiteralType(1), LiteralType(2))) SourceOrigin(location=<SourceLocation all_ast_nodes.py:27>)
    ...
    dict_literal0[1] = 2
    # Dict: DictType({1: TensorType([x_size0, x_size1], torch.int32), 'y': TensorType([x_size0, x_size1], torch.int32)}) SourceOrigin(location=<SourceLocation all_ast_nodes.py:33>)
    ...
    # Dict: DictType({'foo': LiteralType('bar'), 1: TensorType([x_size0, x_size1], torch.int32), 'y': TensorType([x_size0, x_size1], torch.int32)}) SourceOrigin(location=<SourceLocation all_ast_nodes.py:34>)
    ...
    # Name: DictType({1: TensorType([x_size0, x_size1], torch.int32), 'y': TensorType([x_size0, x_size1], torch.int32)}) SourceOrigin(location=<SourceLocation all_ast_nodes.py:33>)
    dict_literal2 = {'foo': 'bar', **dict_literal1}
    # UnaryOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:35>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    uadd = +x
    # UnaryOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:36>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    usub = -x
    # UnaryOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:37>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    invert = ~x
    # UnaryOp: SymBoolType(Eq(u0, 1)) SourceOrigin(location=<SourceLocation all_ast_nodes.py:38>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    not_ = not x
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:39>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    add = x + y
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:40>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    sub = x - y
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:41>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    mul = x * y
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:43>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    truediv = x / y
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:44>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    floordiv = x // y
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:45>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    mod = x % y
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:46>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    pow = x ** y
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:47>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    lshift = x << y
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:48>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    rshift = x >> y
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:49>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    bitwise_and = x & y
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:50>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    bitwise_xor = x ^ y
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:51>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    bitwise_or = x | y
    # BoolOp: UnknownType('And not supported on TensorType([x_size0, x_size1], torch.int32) and TensorType([x_size0, x_size1], torch.int32)') SourceOrigin(location=<SourceLocation all_ast_nodes.py:52>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    and_ = x and y
    # BoolOp: UnknownType('And not supported on TensorType([x_size0, x_size1], torch.int32) and TensorType([x_size0, x_size1], torch.int32)') SourceOrigin(location=<SourceLocation all_ast_nodes.py:53>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    or_ = x and y
    # Compare: TensorType([x_size0, x_size1], torch.bool) SourceOrigin(location=<SourceLocation all_ast_nodes.py:54>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    eq = x == y
    # Compare: TensorType([x_size0, x_size1], torch.bool) SourceOrigin(location=<SourceLocation all_ast_nodes.py:55>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    ne = x != y
    # Compare: TensorType([x_size0, x_size1], torch.bool) SourceOrigin(location=<SourceLocation all_ast_nodes.py:56>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    lt = x < y
    # Compare: TensorType([x_size0, x_size1], torch.bool) SourceOrigin(location=<SourceLocation all_ast_nodes.py:57>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    le = x <= y
    # Compare: TensorType([x_size0, x_size1], torch.bool) SourceOrigin(location=<SourceLocation all_ast_nodes.py:58>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    gt = x > y
    # Compare: TensorType([x_size0, x_size1], torch.bool) SourceOrigin(location=<SourceLocation all_ast_nodes.py:59>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    ge = x >= y
    ...
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    not_in = x not in y
    # Call: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:64>)
    # Name: CallableType(func) GlobalOrigin(name='func', function=<HostFunction all_ast_nodes>)
    # Name: graph():
    ...
    call0 = func(x, y, 3)
    # Call: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:65>)
    # Name: CallableType(func) GlobalOrigin(name='func', function=<HostFunction all_ast_nodes>)
    # Name: graph():
    # Name:     %a_1 : [num_users=1] = placeholder[target=a_1]
    # Name:     %b_1 : [num_users=0] = placeholder[target=b_1]
    ...
    call1 = func(x, y, c=3)
    # Call: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:66>)
    # Name: CallableType(func) GlobalOrigin(name='func', function=<HostFunction all_ast_nodes>)
    # Name: graph():
    # Name:     %a_1 : [num_users=1] = placeholder[target=a_1]
    # Name:     %b_1 : [num_users=0] = placeholder[target=b_1]
    ...
    # Name:     %add_1 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add, %c_1), kwargs = {})
    # Name:     return add_1
    # Tuple: SequenceType((TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32))) SourceOrigin(location=<SourceLocation all_ast_nodes.py:66>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    call2 = func(*(x, y, y))
    # Call: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:67>)
    # Name: CallableType(func) GlobalOrigin(name='func', function=<HostFunction all_ast_nodes>)
    # Name: graph():
    # Name:     %a_1 : [num_users=1] = placeholder[target=a_1]
    # Name:     %b_1 : [num_users=0] = placeholder[target=b_1]
    ...
    # Name:     return add_1
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Dict: DictType({'b': TensorType([x_size0, x_size1], torch.int32), 'c': TensorType([x_size0, x_size1], torch.int32)}) SourceOrigin(location=<SourceLocation all_ast_nodes.py:67>)
    ...
    # IfExp: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Name: UnknownType('And not supported on TensorType([x_size0, x_size1], torch.int32) and TensorType([x_size0, x_size1], torch.int32)') SourceOrigin(location=<SourceLocation all_ast_nodes.py:53>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    ifexp = x if or_ else y
    # Attribute: LiteralType(torch.int32) AttributeOrigin(value=ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>), key='dtype')
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    attr0 = x.dtype
    # Attribute: SequenceType((SymIntType(s0), SymIntType(s1))) AttributeOrigin(value=ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>), key='shape')
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    attr1 = x.shape
    # Call: SymIntType(s0) SourceOrigin(location=<SourceLocation all_ast_nodes.py:75>)
    # Attribute: TensorAttributeType AttributeOrigin(value=ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>), key='size')
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # Constant: LiteralType(0) SourceOrigin(location=<SourceLocation all_ast_nodes.py:75>)
    attr2 = x.size(0)
    # Call: SequenceType((SymIntType(s0), SymIntType(s1))) SourceOrigin(location=<SourceLocation all_ast_nodes.py:76>)
    # Attribute: TensorAttributeType AttributeOrigin(value=ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>), key='size')
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    attr3 = x.size()
    # Call: UnknownType('Tensor.stride() is not supported') SourceOrigin(location=<SourceLocation all_ast_nodes.py:77>)
    # Attribute: TensorAttributeType AttributeOrigin(value=ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>), key='stride')
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    attr4 = x.stride()
    ...
    attr5 = x.stride(0)
    # NamedExpr: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:79>)
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:79>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    # Constant: LiteralType(1) SourceOrigin(location=<SourceLocation all_ast_nodes.py:79>)
    named_expr = (z := (y + 1))
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:80>)
    # Name: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:79>)
    # Constant: LiteralType(1) SourceOrigin(location=<SourceLocation all_ast_nodes.py:80>)
    zzz = zz = z - 1
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:81>)
    # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:81>)
    # Name: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:80>)
    # Name: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:80>)
    # Name: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:79>)
    q = zzz + zz + z
    # Subscript: UnknownType('Subscript not supported with self=SequenceType([TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32), LiteralType(1024)]) key=LiteralType(0)') SourceOrigin(location=<SourceLocation all_ast_nodes.py:82>)
    # Name: SequenceType([TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32), LiteralType(1024)]) SourceOrigin(location=<SourceLocation all_ast_nodes.py:26>)
    # Constant: LiteralType(0) SourceOrigin(location=<SourceLocation all_ast_nodes.py:82>)
    subscript0 = list_literal0[0]
    # Subscript: SequenceType([TensorType([x_size0, x_size1], torch.int32), LiteralType(1024)]) SourceOrigin(location=<SourceLocation all_ast_nodes.py:83>)
    # Name: SequenceType([TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32), LiteralType(1024)]) SourceOrigin(location=<SourceLocation all_ast_nodes.py:26>)
    ...
    # Subscript: SequenceType([TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32)]) SourceOrigin(location=<SourceLocation all_ast_nodes.py:84>)
    # Name: SequenceType([TensorType([x_size0, x_size1], torch.int32), TensorType([x_size0, x_size1], torch.int32), LiteralType(1024)]) SourceOrigin(location=<SourceLocation all_ast_nodes.py:26>)
    ...
    # Name: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:39>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    add += y
    # Name: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:39>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    ...
    try:
        ...
        # Name: CallableType(Exception) BuiltinOrigin(name='Exception', function=<HostFunction all_ast_nodes>)
        raise Exception()
    ...
    if x is y:
        # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
        join_var0 = x
        # BinOp: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:114>)
        # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
        # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
        join_var1 = x + y
        ...
        join_var2 = 2
    # List: SequenceType([TensorType([x_size0, x_size1], torch.int32), UnknownType("Can't combine types from control flow: TensorType([x_size0, x_size1], torch.int32) and LiteralType(None)"), SymIntType(u8)]) SourceOrigin(location=<SourceLocation all_ast_nodes.py:120>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y', function=<HostFunction all_ast_nodes>)
    # Name: UnknownType("Can't combine types from control flow: TensorType([x_size0, x_size1], torch.int32) and LiteralType(None)") SourceOrigin(location=<SourceLocation all_ast_nodes.py:118>)
    ...
    # Name: CallableType(range) BuiltinOrigin(name='range', function=<HostFunction all_ast_nodes>)
    ...
    for i in range(3):
        ...
        v = v + i
        # BinOp: ChainedUnknownType("Can't combine types from control flow: LiteralType(0) and TensorType([x_size0, x_size1], torch.int32)") SourceOrigin(location=<SourceLocation all_ast_nodes.py:126>)
        # Name: UnknownType("Can't combine types from control flow: LiteralType(0) and TensorType([x_size0, x_size1], torch.int32)") SourceOrigin(location=<SourceLocation all_ast_nodes.py:126>)
        # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
        z = z + x
        break
    else:
        ...
        t = 0
    # List: SequenceType([SymIntType(u13), ChainedUnknownType("Can't combine types from control flow: LiteralType(0) and TensorType([x_size0, x_size1], torch.int32)")]) SourceOrigin(location=<SourceLocation all_ast_nodes.py:130>)
    # Name: SymIntType(u13) SourceOrigin(location=<SourceLocation all_ast_nodes.py:125>)
    # Name: ChainedUnknownType("Can't combine types from control flow: LiteralType(0) and TensorType([x_size0, x_size1], torch.int32)") SourceOrigin(location=<SourceLocation all_ast_nodes.py:126>)
    combined = [v, z]
    ...
    # Global: UnknownType('ast.Global is not supported') SourceOrigin(location=<SourceLocation all_ast_nodes.py:142>)
        e3 = 1
    global global0
    # Call: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:144>)
    # Attribute: CallableType(_VariableFunctionsClass.empty_like) AttributeOrigin(value=GlobalOrigin(name='torch', function=<HostFunction all_ast_nodes>), key='empty_like')
    # Attribute: graph():
    # Attribute:     %arg0_1 : [num_users=2] = placeholder[target=arg0_1]
    # Attribute:     %sym_size_int : [num_users=1] = call_function[target=torch.ops.aten.sym_size.int](args = (%arg0_1, 0), kwargs = {})
    # Attribute:     %sym_size_int_1 : [num_users=1] = call_function[target=torch.ops.aten.sym_size.int](args = (%arg0_1, 1), kwargs = {})
    ...
    # Attribute:     %permute : [num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%empty, [0, 1]), kwargs = {})
    # Attribute:     return permute
    # Name: PythonModuleType(torch) GlobalOrigin(name='torch', function=<HostFunction all_ast_nodes>)
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x', function=<HostFunction all_ast_nodes>)
    # For: loop_type=GRID
    out = torch.empty_like(x)
    # Call: IterType(SequenceType([TileIndexType, TileIndexType])) SourceOrigin(location=<SourceLocation all_ast_nodes.py:145>)
    # Attribute: CallableType(tile) AttributeOrigin(value=GlobalOrigin(name='hl', function=<HostFunction all_ast_nodes>), key='tile')
    # Name: PythonModuleType(helion.language) GlobalOrigin(name='hl', function=<HostFunction all_ast_nodes>)
    # Call: SequenceType((SymIntType(s0), SymIntType(s1))) SourceOrigin(location=<SourceLocation all_ast_nodes.py:145>)
    # Attribute: TensorAttributeType AttributeOrigin(value=SourceOrigin(location=<SourceLocation all_ast_nodes.py:144>), key='size')
    # Name: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:144>)
    for tile in hl.tile(out.size()):
        # Subscript: TensorType([block_size0, block_size1], torch.int32) DeviceOrigin(location=<SourceLocation all_ast_nodes.py:146>)
        # Name: TensorType([x_size0, x_size1], torch.int32) SourceOrigin(location=<SourceLocation all_ast_nodes.py:144>)
        # Name: SequenceType([TileIndexType, TileIndexType]) SourceOrigin(location=<SourceLocation all_ast_nodes.py:145>)
