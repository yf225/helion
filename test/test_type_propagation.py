...
def add(x, y):
    ...
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y')
...
def all_ast_nodes(x, y):
    ...
    # IfExp: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='y')
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x')
    ...
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x')
    attr0 = x.dtype
    # Attribute: SequenceType((SymIntType(s0), SymIntType(s1))) AttributeOrigin(value=ArgumentOrigin(name='x'), key='shape')
    # Name: TensorType([x_size0, x_size1], torch.int32) ArgumentOrigin(name='x')
    attr1 = x.shape
