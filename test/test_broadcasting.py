...
@triton.jit
def _broadcast_fn_kernel(_a, _b, _out0, _out1, _a_size_0, _a_size_1, _a_stride_0, _a_stride_1, _b_stride_0, _out0_stride_0, _out0_stride_1, _out1_stride_0, _out1_stride_1, _BLOCK_SIZE_0: tl.constexpr, _BLOCK_SIZE_1: tl.constexpr):
...
@triton.jit
def _broadcast_fn_kernel(_a, _b, _out0, _out1, _a_size_0, _a_size_1, _a_stride_0, _a_stride_1, _b_stride_0, _out0_stride_0, _out0_stride_1, _out1_stride_0, _out1_stride_1, _BLOCK_SIZE_1: tl.constexpr, _BLOCK_SIZE_0: tl.constexpr):
    _block_idx_1 = tl.program_id(0) * _BLOCK_SIZE_1 + tl.arange(0, _BLOCK_SIZE_1).to(tl.int32)
    _mask_1 = _block_idx_1 < _a_size_1
...
@triton.jit
def _broadcast_fn_kernel(_a, _b, _out0, _out1, _a_size_0, _a_stride_0, _a_stride_1, _b_stride_0, _out0_stride_0, _out0_stride_1, _out1_stride_0, _out1_stride_1, _BLOCK_SIZE_0: tl.constexpr):
    _block_idx_0 = tl.program_id(0) * _BLOCK_SIZE_0 + tl.arange(0, _BLOCK_SIZE_0).to(tl.int32)
    _mask_0 = _block_idx_0 < _a_size_0
...
@triton.jit
def _broadcast_fn_kernel(_a, _b, _out0, _out1, _a_size_1, _a_stride_0, _a_stride_1, _b_stride_0, _out0_stride_0, _out0_stride_1, _out1_stride_0, _out1_stride_1, _BLOCK_SIZE_1: tl.constexpr):
...
def broadcast_fn(a, b):
    ...
    out1 = torch.empty_like(a)
    _BLOCK_SIZE_1 = 64
    _broadcast_fn_kernel[a.size(0), triton.cdiv(a.size(1), _BLOCK_SIZE_1)](a, b, out0, out1, a.size(1), a.stride(0), a.stride(1), b.stride(0), out0.stride(0), out0.stride(1), out1.stride(0), out1.stride(1), _BLOCK_SIZE_1, num_warps=4, num_stages=3)
    return (out0, out1)""",
        )
...
@triton.jit
def _fn_kernel(_a, _out0, _out1, _out2, _a_size_0, _a_size_1, _a_stride_0, _a_stride_1, _out0_stride_0, _out0_stride_1, _out1_stride_0, _out1_stride_1, _out2_stride_0, _out2_stride_1, _idx1, _BLOCK_SIZE_0: tl.constexpr, _BLOCK_SIZE_1: tl.constexpr):
    _block_idx_0 = tl.program_id(0) * _BLOCK_SIZE_0 + tl.arange(0, _BLOCK_SIZE_0).to(tl.int32)
    _mask_0 = _block_idx_0 < _a_size_0
    _block_idx_1 = tl.program_id(1) * _BLOCK_SIZE_1 + tl.arange(0, _BLOCK_SIZE_1).to(tl.int32)
    _mask_1 = _block_idx_1 < _a_size_1
